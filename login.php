...
<html lang="es">
  ...
  <body>
    <header id="header" class="">
      <h1 class="display-4  d-flex  justify-content-center m-5">
        <div class="mx-auto">
          Inicio de Sesión
        </div>
      </h1>
      <nav class="navbar navbar-expand-lg  mt-3 bg-dark">
        <button
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item text-white">
              ...
              >Jenis Sagbini <span class="text-lowercase text-capitalize">- Proyectos & Ingenieria</span> </a>
          ...
          <ul class="nav nav-tabs my-2 my-lg-0">
            <li class="nav-item text-white">
              <a
                ...
                href="index.php"
                class="nav-link text-white pt-0 active"
                >Inicio</a
              >
            </li>
            <li class="nav-item text-white">
              <a
                style="height: 30px; cursor: pointer;"
                href="quien-soy.php"
                class="nav-link text-white pt-0"
                >¿Quién soy?</a
              >
            </li>
            <li class="nav-item text-white">
              ...
              <div class="">
                <div class="d-flex justify-content-center">
                  <button
                    id="btn-enviar"
                    type="submit"
                    class="btn btn-dark btn-raised btn-sm"
                  >
                    Sign In
                  </button>
                </div>
